...
// an instance of this class is constructed from DB/LDAP/REST information by my UserDetailsService
// kept in the user session and accessible in any future HTTP request via RequestContextHolder.
public class SecurityUser implements UserDetails {
	...
	SecurityUser(String username, UserRole role, String fullName, Set<Long> managedTeacherIds) {
