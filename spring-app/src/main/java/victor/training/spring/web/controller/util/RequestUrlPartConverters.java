...
import victor.training.spring.web.controller.VictimController.MessageColumn;
...
public class RequestUrlPartConverters implements WebMvcConfigurer {
    ...
    public void addFormatters(FormatterRegistry registry) {
        ...
        registry.addConverter(String.class, MessageColumn.class, MessageColumn::valueOf);
    }
}
