...
class OrderExporter {
   ...
   OrderExporter(InvoiceExporter invoiceExporter, LabelServiceFactory labelServiceFactory) {
   ...
   public void export(Locale locale) {
      ...
      LabelService labelService = labelServiceFactory.create(locale);
...
class LabelServiceFactory {
   ...
   LabelServiceFactory(ObjectFactory<LabelService> labelServiceFactory) {
      this.labelServiceFactory = labelServiceFactory;
   }

   public LabelService create(Locale locale) {
      // encapsulated the temporal coupling COns: +1 class.
