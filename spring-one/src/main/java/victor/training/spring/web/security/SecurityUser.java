...
// NU INCERCA SA IMPLEMENTEZI UserDetails din SPring cu Entitatea ta User de Hibernate
public class SecurityUser implements UserDetails { // instantele astea stau in sesiunea userului.
