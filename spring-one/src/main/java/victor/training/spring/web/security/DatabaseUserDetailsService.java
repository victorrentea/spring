...
// met asta ruleaza doar 1 data la login
    // locul ideal sa aduci din LDAP sau DB rolurile userului


    // obiectul intors mai jos RAMANE IN HttpSession asociat cookiului tau JSESSION
